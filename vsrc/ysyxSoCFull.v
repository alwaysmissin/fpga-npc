...
module APBFanout(	// rocket-chip/src/main/scala/amba/apb/Xbar.scala:28:9
  ...
  assign auto_anon_in_pslverr =
    ...
    & auto_anon_out_2_pslverr;	// rocket-chip/src/main/scala/amba/apb/Xbar.scala:28:9, :48:87, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}, src/main/scala/chisel3/util/Mux.scala:30:73
  assign auto_anon_in_prdata =
    ...
    | (sel_4 ? auto_anon_out_4_prdata : 32'h0);	// rocket-chip/src/main/scala/amba/apb/Xbar.scala:28:9, :48:87, rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}, src/main/scala/chisel3/util/Mux.scala:30:73
...
module BitsToSeg(	// src/device/GPIO.scala:28:7
  input  [3:0] io_in,	// src/device/GPIO.scala:29:14
  output [7:0] io_seg	// src/device/GPIO.scala:29:14
);
  ...
  wire [15:0][7:0] _GEN =
    '{8'h71,
      ...
      8'h25,
      8'h9F,
      8'h3};	// src/device/GPIO.scala:34:12, :35:12, :36:12, :37:12, :38:12, :39:12, :40:12, :41:12, :42:12, :43:12, :44:12, :45:12, :46:12, :47:12, :48:12, :49:12, src/main/scala/chisel3/util/Mux.scala:126:16
  assign io_seg = _GEN[io_in];	// src/device/GPIO.scala:28:7, :34:12, :35:12, :36:12, :37:12, :38:12, :39:12, :40:12, :41:12, :42:12, :43:12, :44:12, :45:12, :46:12, :47:12, :48:12, :49:12, src/main/scala/chisel3/util/Mux.scala:126:16
endmodule
...
module gpioChisel(	// src/device/GPIO.scala:53:7
  ...
  output [7:0]  io_gpio_seg_0,	// src/device/GPIO.scala:54:14
                io_gpio_seg_1,	// src/device/GPIO.scala:54:14
                io_gpio_seg_2,	// src/device/GPIO.scala:54:14
                io_gpio_seg_3,	// src/device/GPIO.scala:54:14
                io_gpio_seg_4,	// src/device/GPIO.scala:54:14
                io_gpio_seg_5,	// src/device/GPIO.scala:54:14
                io_gpio_seg_6,	// src/device/GPIO.scala:54:14
                io_gpio_seg_7	// src/device/GPIO.scala:54:14
);
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/device/GPIO.scala:53:7
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  BitsToSeg seg (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[3:0]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_0)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_1 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[7:4]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_1)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_2 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[11:8]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_2)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_3 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[15:12]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_3)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_4 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[19:16]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_4)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_5 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[23:20]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_5)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_6 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[27:24]),	// src/device/GPIO.scala:57:23, :63:24
    .io_seg (io_gpio_seg_6)
  );	// src/device/GPIO.scala:62:21
  BitsToSeg seg_7 (	// src/device/GPIO.scala:62:21
    .io_in  (segReg[31:28]),	// src/device/GPIO.scala:57:23, :63:24
...
module APBGPIO(	// src/device/GPIO.scala:118:9
  ...
  output [7:0]  gpio_bundle_seg_0,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_1,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_2,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_3,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_4,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_5,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_6,	// src/device/GPIO.scala:120:25
                gpio_bundle_seg_7	// src/device/GPIO.scala:120:25
);
...
// VCS coverage exclude_file
module g_memory_524287x24(	// src/device/VGA.scala:54:23
  input  [18:0] R0_addr,
  input         R0_en,
                R0_clk,
  output [23:0] R0_data,
  ...
  reg [23:0] Memory[0:524286];	// src/device/VGA.scala:54:23
  always @(posedge W0_clk) begin	// src/device/VGA.scala:54:23
    if (W0_en & 1'h1)	// src/device/VGA.scala:54:23
      Memory[W0_addr] <= W0_data;	// src/device/VGA.scala:54:23
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_MEM_	// src/device/VGA.scala:54:23
    reg [31:0] _RANDOM_MEM;	// src/device/VGA.scala:54:23
    initial begin	// src/device/VGA.scala:54:23
      `INIT_RANDOM_PROLOG_	// src/device/VGA.scala:54:23
      `ifdef RANDOMIZE_MEM_INIT	// src/device/VGA.scala:54:23
        for (logic [18:0] i = 19'h0; i < 19'h7FFFF; i += 19'h1) begin
          _RANDOM_MEM = `RANDOM;	// src/device/VGA.scala:54:23
          Memory[i] = _RANDOM_MEM[23:0];	// src/device/VGA.scala:54:23
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 24'bx;	// src/device/VGA.scala:54:23
endmodule

module vgaChisel(	// src/device/VGA.scala:47:7
  input         io_clock,	// src/device/VGA.scala:48:14
                io_reset,	// src/device/VGA.scala:48:14
                io_in_psel,	// src/device/VGA.scala:48:14
                io_in_pwrite,	// src/device/VGA.scala:48:14
  input  [31:0] io_in_paddr,	// src/device/VGA.scala:48:14
                io_in_pwdata,	// src/device/VGA.scala:48:14
  output        io_in_pready,	// src/device/VGA.scala:48:14
  output [7:0]  io_vga_r,	// src/device/VGA.scala:48:14
                io_vga_g,	// src/device/VGA.scala:48:14
                io_vga_b,	// src/device/VGA.scala:48:14
  output        io_vga_hsync,	// src/device/VGA.scala:48:14
                io_vga_vsync,	// src/device/VGA.scala:48:14
                io_vga_valid	// src/device/VGA.scala:48:14
);

  wire [23:0] _g_memory_ext_R0_data;	// src/device/VGA.scala:54:23
  wire [9:0]  _vga_ctrl_h_addr;	// src/device/VGA.scala:51:26
  wire [9:0]  _vga_ctrl_v_addr;	// src/device/VGA.scala:51:26
  reg         pready;	// src/device/VGA.scala:58:25
  always @(posedge io_clock) begin	// src/device/VGA.scala:48:14
    if (io_reset)	// src/device/VGA.scala:48:14
      pready <= 1'h0;	// src/device/VGA.scala:47:7, :58:25
    else	// src/device/VGA.scala:48:14
      pready <= io_in_psel;	// src/device/VGA.scala:58:25
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/device/VGA.scala:47:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/device/VGA.scala:47:7
      `FIRRTL_BEFORE_INITIAL	// src/device/VGA.scala:47:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/device/VGA.scala:47:7
      automatic logic [31:0] _RANDOM[0:0];	// src/device/VGA.scala:47:7
      `ifdef INIT_RANDOM_PROLOG_	// src/device/VGA.scala:47:7
        `INIT_RANDOM_PROLOG_	// src/device/VGA.scala:47:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/device/VGA.scala:47:7
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// src/device/VGA.scala:47:7
        pready = _RANDOM[/*Zero width*/ 1'b0][0];	// src/device/VGA.scala:47:7, :58:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/device/VGA.scala:47:7
      `FIRRTL_AFTER_INITIAL	// src/device/VGA.scala:47:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  vga_ctrl vga_ctrl (	// src/device/VGA.scala:51:26
    .pclk     (io_clock),
    .reset    (io_reset),
    .vga_data (_g_memory_ext_R0_data),	// src/device/VGA.scala:54:23
    ...
    .vga_g    (io_vga_g),
    .vga_b    (io_vga_b)
  );	// src/device/VGA.scala:51:26
  g_memory_524287x24 g_memory_ext (	// src/device/VGA.scala:54:23
    .R0_addr ({_vga_ctrl_v_addr[8:0], _vga_ctrl_h_addr}),	// src/device/VGA.scala:51:26, :73:37
    .R0_en   (1'h1),	// src/device/VGA.scala:47:7
    .R0_clk  (io_clock),
    .R0_data (_g_memory_ext_R0_data),
    .W0_addr (io_in_paddr[20:2]),	// src/device/VGA.scala:65:{25,37}
    .W0_en   (io_in_psel & io_in_pwrite),	// src/device/VGA.scala:54:23, :62:25, :64:28
    .W0_clk  (io_clock),
    .W0_data (io_in_pwdata[23:0])	// src/device/VGA.scala:65:58
  );	// src/device/VGA.scala:54:23
  assign io_in_pready = pready;	// src/device/VGA.scala:47:7, :58:25
endmodule

module APBVGA(	// src/device/VGA.scala:93:9
  input         clock,	// src/device/VGA.scala:93:9
                reset,	// src/device/VGA.scala:93:9
                auto_in_psel,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
                auto_in_pwrite,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  ...
  input  [31:0] auto_in_pwdata,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  output        auto_in_pready,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  output [7:0]  vga_bundle_r,	// src/device/VGA.scala:95:24
                vga_bundle_g,	// src/device/VGA.scala:95:24
                vga_bundle_b,	// src/device/VGA.scala:95:24
  output        vga_bundle_hsync,	// src/device/VGA.scala:95:24
                vga_bundle_vsync,	// src/device/VGA.scala:95:24
                vga_bundle_valid	// src/device/VGA.scala:95:24
);

  vgaChisel mvga (	// src/device/VGA.scala:97:22
    .io_clock     (clock),
    .io_reset     (reset),
    .io_in_psel   (auto_in_psel),
    .io_in_pwrite (auto_in_pwrite),
    .io_in_paddr  ({2'h0, auto_in_paddr}),	// src/device/VGA.scala:100:16
    .io_in_pwdata (auto_in_pwdata),
    .io_in_pready (auto_in_pready),
...
module APBPSRAM(	// src/device/PSRAM.scala:222:9
  input         clock,	// src/device/PSRAM.scala:222:9
                reset,	// src/device/PSRAM.scala:222:9
                auto_in_psel,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
                auto_in_penable,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
                auto_in_pwrite,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  ...
  output        auto_in_pready,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
                auto_in_pslverr,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  output [31:0] auto_in_prdata,	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25
  output        qspi_bundle_sck,	// src/device/PSRAM.scala:224:25
                qspi_bundle_ce_n,	// src/device/PSRAM.scala:224:25
  inout  [3:0]  qspi_bundle_dio	// src/device/PSRAM.scala:224:25
);

  psram_top_apb mpsram (	// src/device/PSRAM.scala:226:24
    .clock      (clock),
    .reset      (reset),
    .in_psel    (auto_in_psel),
    .in_penable (auto_in_penable),
    ...
    .in_pprot   (3'h1),	// rocket-chip/dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:100:25, src/device/PSRAM.scala:226:24
    .in_pwdata  (auto_in_pwdata),
    .in_pstrb   (auto_in_pstrb),
    .in_pready  (auto_in_pready),
    .in_pslverr (auto_in_pslverr),
...
module APBDelayerChisel(	// src/amba/APBDelayer.scala:32:7
  input         clock,	// src/amba/APBDelayer.scala:32:7
                reset,	// src/amba/APBDelayer.scala:32:7
                io_in_psel,	// src/amba/APBDelayer.scala:34:14
                io_in_penable,	// src/amba/APBDelayer.scala:34:14
                io_in_pwrite,	// src/amba/APBDelayer.scala:34:14
  input  [31:0] io_in_paddr,	// src/amba/APBDelayer.scala:34:14
                io_in_pwdata,	// src/amba/APBDelayer.scala:34:14
  input  [3:0]  io_in_pstrb,	// src/amba/APBDelayer.scala:34:14
  output        io_in_pready,	// src/amba/APBDelayer.scala:34:14
                io_in_pslverr,	// src/amba/APBDelayer.scala:34:14
  output [31:0] io_in_prdata,	// src/amba/APBDelayer.scala:34:14
  output        io_out_psel,	// src/amba/APBDelayer.scala:34:14
                io_out_penable,	// src/amba/APBDelayer.scala:34:14
                io_out_pwrite,	// src/amba/APBDelayer.scala:34:14
  output [31:0] io_out_paddr,	// src/amba/APBDelayer.scala:34:14
                io_out_pwdata,	// src/amba/APBDelayer.scala:34:14
  output [3:0]  io_out_pstrb,	// src/amba/APBDelayer.scala:34:14
  input         io_out_pready,	// src/amba/APBDelayer.scala:34:14
                io_out_pslverr,	// src/amba/APBDelayer.scala:34:14
  input  [31:0] io_out_prdata	// src/amba/APBDelayer.scala:34:14
);

  reg  [1:0]  state;	// src/amba/APBDelayer.scala:36:22
  reg         apbResppslverrReg;	// src/amba/APBDelayer.scala:37:34
  reg  [31:0] apbRespprdataReg;	// src/amba/APBDelayer.scala:38:33
  reg  [31:0] waitCounter;	// src/amba/APBDelayer.scala:39:28
  reg  [31:0] delayDecounter;	// src/amba/APBDelayer.scala:40:31
  wire        _io_out_pwrite_T_1 = state == 2'h1;	// src/amba/APBDelayer.scala:32:7, :36:22, :74:59
  always @(posedge clock) begin	// src/amba/APBDelayer.scala:32:7
    if (reset) begin	// src/amba/APBDelayer.scala:32:7
      state <= 2'h0;	// src/amba/APBDelayer.scala:32:7, :36:22
      apbResppslverrReg <= 1'h0;	// src/amba/APBDelayer.scala:37:34
      apbRespprdataReg <= 32'h0;	// src/amba/APBDelayer.scala:38:33
      waitCounter <= 32'h0;	// src/amba/APBDelayer.scala:39:28
      delayDecounter <= 32'h0;	// src/amba/APBDelayer.scala:40:31
    end
    else if (|state) begin	// src/amba/APBDelayer.scala:36:22, :41:17
      automatic logic            _GEN;	// src/amba/APBDelayer.scala:58:28
      automatic logic [3:0][1:0] _GEN_0;	// src/amba/APBDelayer.scala:36:22, :41:17, :49:27, :58:37, :65:13
      _GEN = delayDecounter == 32'h0;	// src/amba/APBDelayer.scala:40:31, :58:28
      _GEN_0 = {{2'h0}, {_GEN ? 2'h3 : state}, {io_out_pready ? 2'h2 : state}, {state}};	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17, :49:27, :50:15, :58:{28,37}, :59:15, :65:13
      state <= _GEN_0[state];	// src/amba/APBDelayer.scala:36:22, :41:17, :49:27, :58:37, :65:13
      if (state == 2'h1) begin	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17
        if (io_out_pready) begin	// src/amba/APBDelayer.scala:34:14
          automatic logic [32:0] _delayDecounter_T;	// src/amba/APBDelayer.scala:53:40
          apbResppslverrReg <= io_out_pslverr;	// src/amba/APBDelayer.scala:37:34
          apbRespprdataReg <= io_out_prdata;	// src/amba/APBDelayer.scala:38:33
          _delayDecounter_T = {1'h0, waitCounter} * 33'h9;	// src/amba/APBDelayer.scala:39:28, :53:40
          delayDecounter <= _delayDecounter_T[32:1] - waitCounter;	// src/amba/APBDelayer.scala:39:28, :40:31, :53:{40,56,76}
        end
        waitCounter <= waitCounter + 32'h1;	// src/amba/APBDelayer.scala:39:28, :48:34
      end
      else begin	// src/amba/APBDelayer.scala:41:17
        automatic logic _GEN_1;	// src/amba/APBDelayer.scala:41:17
        automatic logic _GEN_2;	// src/amba/APBDelayer.scala:37:34, :41:17
        _GEN_1 = state == 2'h2;	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17
        _GEN_2 = _GEN_1 | state != 2'h3;	// src/amba/APBDelayer.scala:32:7, :36:22, :37:34, :41:17
        apbResppslverrReg <= _GEN_2 & apbResppslverrReg;	// src/amba/APBDelayer.scala:37:34, :41:17
        if (_GEN_2) begin	// src/amba/APBDelayer.scala:37:34, :38:33, :41:17
        end
        else	// src/amba/APBDelayer.scala:38:33, :41:17
          apbRespprdataReg <= 32'h0;	// src/amba/APBDelayer.scala:38:33
        if (_GEN_1 & _GEN)	// src/amba/APBDelayer.scala:39:28, :41:17, :58:{28,37}, :60:21
          waitCounter <= 32'h0;	// src/amba/APBDelayer.scala:39:28
        if (_GEN_1) begin	// src/amba/APBDelayer.scala:41:17
          if (_GEN)	// src/amba/APBDelayer.scala:58:28
            delayDecounter <= 32'h0;	// src/amba/APBDelayer.scala:40:31
          else	// src/amba/APBDelayer.scala:58:28
            delayDecounter <= delayDecounter - 32'h1;	// src/amba/APBDelayer.scala:40:31, :57:40
        end
      end
    end
    else if (io_in_psel)	// src/amba/APBDelayer.scala:34:14
      state <= 2'h1;	// src/amba/APBDelayer.scala:32:7, :36:22
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/amba/APBDelayer.scala:32:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/amba/APBDelayer.scala:32:7
      `FIRRTL_BEFORE_INITIAL	// src/amba/APBDelayer.scala:32:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/amba/APBDelayer.scala:32:7
      automatic logic [31:0] _RANDOM[0:3];	// src/amba/APBDelayer.scala:32:7
      `ifdef INIT_RANDOM_PROLOG_	// src/amba/APBDelayer.scala:32:7
        `INIT_RANDOM_PROLOG_	// src/amba/APBDelayer.scala:32:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/amba/APBDelayer.scala:32:7
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// src/amba/APBDelayer.scala:32:7
        end	// src/amba/APBDelayer.scala:32:7
        state = _RANDOM[2'h0][1:0];	// src/amba/APBDelayer.scala:32:7, :36:22
        apbResppslverrReg = _RANDOM[2'h0][2];	// src/amba/APBDelayer.scala:32:7, :36:22, :37:34
        apbRespprdataReg = {_RANDOM[2'h0][31:3], _RANDOM[2'h1][2:0]};	// src/amba/APBDelayer.scala:32:7, :36:22, :38:33
        waitCounter = {_RANDOM[2'h1][31:3], _RANDOM[2'h2][2:0]};	// src/amba/APBDelayer.scala:32:7, :38:33, :39:28
        delayDecounter = {_RANDOM[2'h2][31:3], _RANDOM[2'h3][2:0]};	// src/amba/APBDelayer.scala:32:7, :39:28, :40:31
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/amba/APBDelayer.scala:32:7
      `FIRRTL_AFTER_INITIAL	// src/amba/APBDelayer.scala:32:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_in_pready = &state;	// src/amba/APBDelayer.scala:32:7, :36:22, :77:27
  assign io_in_pslverr = apbResppslverrReg;	// src/amba/APBDelayer.scala:32:7, :37:34
  assign io_in_prdata = apbRespprdataReg;	// src/amba/APBDelayer.scala:32:7, :38:33
  assign io_out_psel = io_in_psel & (~(|state) | _io_out_pwrite_T_1);	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17, :74:{31,41,50,59}
  assign io_out_penable = io_in_penable & (~(|state) | _io_out_pwrite_T_1);	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17, :74:{41,59}, :75:{37,56}
  assign io_out_pwrite = io_in_pwrite & (~(|state) | _io_out_pwrite_T_1);	// src/amba/APBDelayer.scala:32:7, :36:22, :41:17, :74:{41,59}, :76:{35,54}
  assign io_out_paddr = io_in_paddr;	// src/amba/APBDelayer.scala:32:7
  assign io_out_pwdata = io_in_pwdata;	// src/amba/APBDelayer.scala:32:7
  assign io_out_pstrb = io_in_pstrb;	// src/amba/APBDelayer.scala:32:7
endmodule
...
// VCS coverage exclude_file
module ram_8x39(	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  input  [2:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [38:0] R0_data,
  ...
  reg [38:0] Memory[0:7];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  always @(posedge W0_clk) begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
    if (W0_en & 1'h1)	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      Memory[W0_addr] <= W0_data;	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  end // always @(posedge)
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:256:91
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          ...
          Memory[i[2:0]] = _RANDOM_MEM[38:0];	// src/main/scala/chisel3/util/Decoupled.scala:256:91
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
...
module Queue8_AXI4BundleR(	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  wire        io_deq_valid_0 = io_enq_valid | ~empty;	// src/main/scala/chisel3/util/Decoupled.scala:261:25, :285:{16,19}, :297:{24,39}
  wire        do_deq = ~empty & io_deq_ready & io_deq_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, :261:25, :264:27, :285:16, :297:{24,39}, :298:17, :300:14
  wire        do_enq = ~(empty & io_deq_ready) & ~(ptr_match & maybe_full) & io_enq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:51:35, :259:27, :260:33, :261:25, :262:24, :263:27, :286:19, :298:17, :301:{26,35}
  always @(posedge clock) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    if (reset) begin	// src/main/scala/chisel3/util/Decoupled.scala:243:7
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/chisel3/util/Decoupled.scala:243:7
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  ram_8x39 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:256:91
  ...
  assign io_deq_valid = io_deq_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :285:16, :297:{24,39}
  assign io_deq_bits_id = empty ? io_enq_bits_id : _ram_ext_R0_data[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_data = empty ? io_enq_bits_data : _ram_ext_R0_data[35:4];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_resp = empty ? io_enq_bits_resp : _ram_ext_R0_data[37:36];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
  assign io_deq_bits_last = empty ? io_enq_bits_last : _ram_ext_R0_data[38];	// src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19
endmodule
...
module AXI4DelayerChisel(	// src/amba/AXI4Delayer.scala:25:7
  input         clock,	// src/amba/AXI4Delayer.scala:25:7
                reset,	// src/amba/AXI4Delayer.scala:25:7
  output        io_in_awready,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_awvalid,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_awid,	// src/amba/AXI4Delayer.scala:29:14
  input  [31:0] io_in_awaddr,	// src/amba/AXI4Delayer.scala:29:14
  input  [7:0]  io_in_awlen,	// src/amba/AXI4Delayer.scala:29:14
  input  [2:0]  io_in_awsize,	// src/amba/AXI4Delayer.scala:29:14
  input  [1:0]  io_in_awburst,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_awlock,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_awcache,	// src/amba/AXI4Delayer.scala:29:14
  input  [2:0]  io_in_awprot,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_awqos,	// src/amba/AXI4Delayer.scala:29:14
  output        io_in_wready,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_wvalid,	// src/amba/AXI4Delayer.scala:29:14
  input  [31:0] io_in_wdata,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_wstrb,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_wlast,	// src/amba/AXI4Delayer.scala:29:14
                io_in_bready,	// src/amba/AXI4Delayer.scala:29:14
  output        io_in_bvalid,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_in_bid,	// src/amba/AXI4Delayer.scala:29:14
  output [1:0]  io_in_bresp,	// src/amba/AXI4Delayer.scala:29:14
  output        io_in_arready,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_arvalid,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_arid,	// src/amba/AXI4Delayer.scala:29:14
  input  [31:0] io_in_araddr,	// src/amba/AXI4Delayer.scala:29:14
  input  [7:0]  io_in_arlen,	// src/amba/AXI4Delayer.scala:29:14
  input  [2:0]  io_in_arsize,	// src/amba/AXI4Delayer.scala:29:14
  input  [1:0]  io_in_arburst,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_arlock,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_arcache,	// src/amba/AXI4Delayer.scala:29:14
  input  [2:0]  io_in_arprot,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_in_arqos,	// src/amba/AXI4Delayer.scala:29:14
  input         io_in_rready,	// src/amba/AXI4Delayer.scala:29:14
  output        io_in_rvalid,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_in_rid,	// src/amba/AXI4Delayer.scala:29:14
  output [31:0] io_in_rdata,	// src/amba/AXI4Delayer.scala:29:14
  output [1:0]  io_in_rresp,	// src/amba/AXI4Delayer.scala:29:14
  output        io_in_rlast,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_awready,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_awvalid,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_awid,	// src/amba/AXI4Delayer.scala:29:14
  output [31:0] io_out_awaddr,	// src/amba/AXI4Delayer.scala:29:14
  output [7:0]  io_out_awlen,	// src/amba/AXI4Delayer.scala:29:14
  output [2:0]  io_out_awsize,	// src/amba/AXI4Delayer.scala:29:14
  output [1:0]  io_out_awburst,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_awlock,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_awcache,	// src/amba/AXI4Delayer.scala:29:14
  output [2:0]  io_out_awprot,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_awqos,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_wready,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_wvalid,	// src/amba/AXI4Delayer.scala:29:14
  output [31:0] io_out_wdata,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_wstrb,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_wlast,	// src/amba/AXI4Delayer.scala:29:14
                io_out_bready,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_bvalid,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_out_bid,	// src/amba/AXI4Delayer.scala:29:14
  input  [1:0]  io_out_bresp,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_arready,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_arvalid,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_arid,	// src/amba/AXI4Delayer.scala:29:14
  output [31:0] io_out_araddr,	// src/amba/AXI4Delayer.scala:29:14
  output [7:0]  io_out_arlen,	// src/amba/AXI4Delayer.scala:29:14
  output [2:0]  io_out_arsize,	// src/amba/AXI4Delayer.scala:29:14
  output [1:0]  io_out_arburst,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_arlock,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_arcache,	// src/amba/AXI4Delayer.scala:29:14
  output [2:0]  io_out_arprot,	// src/amba/AXI4Delayer.scala:29:14
  output [3:0]  io_out_arqos,	// src/amba/AXI4Delayer.scala:29:14
  output        io_out_rready,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_rvalid,	// src/amba/AXI4Delayer.scala:29:14
  input  [3:0]  io_out_rid,	// src/amba/AXI4Delayer.scala:29:14
  input  [31:0] io_out_rdata,	// src/amba/AXI4Delayer.scala:29:14
  input  [1:0]  io_out_rresp,	// src/amba/AXI4Delayer.scala:29:14
  input         io_out_rlast	// src/amba/AXI4Delayer.scala:29:14
);

  wire        _rDelayCounterQ_deq_q_io_deq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  wire [31:0] _rDelayCounterQ_deq_q_io_deq_bits;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  wire        _rRespQ_deq_q_io_deq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  wire        _rRespQ_deq_q_io_deq_bits_last;	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  reg  [31:0] rWaitCounter;	// src/amba/AXI4Delayer.scala:30:29
  reg  [31:0] rDelayCounter;	// src/amba/AXI4Delayer.scala:31:30
  reg  [31:0] wWaitCounter;	// src/amba/AXI4Delayer.scala:32:29
  reg  [31:0] wDelayCounter;	// src/amba/AXI4Delayer.scala:33:30
  reg  [3:0]  bResp_id;	// src/amba/AXI4Delayer.scala:35:22
  reg  [1:0]  bResp_resp;	// src/amba/AXI4Delayer.scala:35:22
  reg         rChannelBusy;	// src/amba/AXI4Delayer.scala:43:29
  reg         wChannelBusy;	// src/amba/AXI4Delayer.scala:44:29
  reg  [1:0]  rState;	// src/amba/AXI4Delayer.scala:56:23
  wire        _GEN = rState == 2'h0;	// src/amba/AXI4Delayer.scala:56:23, :57:17
  wire        _GEN_0 = rState == 2'h1;	// src/amba/AXI4Delayer.scala:56:23, :57:17
  wire [32:0] _rCounterW_bits_T = {1'h0, rWaitCounter} * 33'h9;	// src/amba/AXI4Delayer.scala:30:29, :72:41
  wire        _GEN_1 = rState == 2'h2;	// src/amba/AXI4Delayer.scala:56:23, :57:17
  reg  [1:0]  wState;	// src/amba/AXI4Delayer.scala:92:23
  wire        io_in_arready_0 = io_out_arready & ~rChannelBusy;	// src/amba/AXI4Delayer.scala:43:29, :125:{41,44}
  wire        io_in_rvalid_0 =
    ~(|rDelayCounter) & _rRespQ_deq_q_io_deq_valid & ~io_out_rvalid;	// src/amba/AXI4Delayer.scala:31:30, :66:42, :128:{38,46,62,65}, src/main/scala/chisel3/util/Decoupled.scala:362:21
  wire        io_in_awready_0 = io_out_awready & ~wChannelBusy;	// src/amba/AXI4Delayer.scala:44:29, :135:{41,44}
  wire        io_in_wready_0 = io_out_wready & ~wChannelBusy;	// src/amba/AXI4Delayer.scala:44:29, :135:44, :137:39
  always @(posedge clock) begin	// src/amba/AXI4Delayer.scala:25:7
    if (reset) begin	// src/amba/AXI4Delayer.scala:25:7
      rWaitCounter <= 32'h0;	// src/amba/AXI4Delayer.scala:30:29
      rDelayCounter <= 32'h0;	// src/amba/AXI4Delayer.scala:31:30
      wWaitCounter <= 32'h0;	// src/amba/AXI4Delayer.scala:32:29
      wDelayCounter <= 32'h0;	// src/amba/AXI4Delayer.scala:33:30
      bResp_id <= io_out_bid;	// src/amba/AXI4Delayer.scala:35:22
      bResp_resp <= io_out_bresp;	// src/amba/AXI4Delayer.scala:35:22
      rChannelBusy <= 1'h0;	// src/amba/AXI4Delayer.scala:43:29
      wChannelBusy <= 1'h0;	// src/amba/AXI4Delayer.scala:44:29
      rState <= 2'h0;	// src/amba/AXI4Delayer.scala:56:23
      wState <= 2'h0;	// src/amba/AXI4Delayer.scala:56:23, :92:23
    end
    else begin	// src/amba/AXI4Delayer.scala:25:7
      automatic logic             _GEN_2;	// src/amba/AXI4Delayer.scala:84:{35,60}
      automatic logic             _GEN_3;	// src/amba/AXI4Delayer.scala:93:17
      automatic logic             _GEN_4;	// src/amba/AXI4Delayer.scala:93:17
      automatic logic             _GEN_5;	// src/amba/AXI4Delayer.scala:109:27
      automatic logic [3:0][31:0] _GEN_6;	// src/amba/AXI4Delayer.scala:30:29, :57:17, :64:20, :84:80
      automatic logic [3:0][31:0] _GEN_7;	// src/amba/AXI4Delayer.scala:31:30, :57:17, :66:21, :84:80
      automatic logic [32:0]      _wDelayCounter_T;	// src/amba/AXI4Delayer.scala:103:40
      automatic logic [3:0][31:0] _GEN_8;	// src/amba/AXI4Delayer.scala:33:30, :93:17, :101:28, :109:35
      automatic logic [3:0][1:0]  _GEN_9;	// src/amba/AXI4Delayer.scala:92:23, :93:17, :95:45, :101:28, :109:35, :116:14
      _GEN_2 =
        ~(|rDelayCounter) & ~_rDelayCounterQ_deq_q_io_deq_valid
        & _rRespQ_deq_q_io_deq_bits_last;	// src/amba/AXI4Delayer.scala:31:30, :66:42, :79:42, :84:{35,38,60}, src/main/scala/chisel3/util/Decoupled.scala:362:21
      _GEN_3 = wState == 2'h0;	// src/amba/AXI4Delayer.scala:56:23, :92:23, :93:17
      _GEN_4 = wState == 2'h1;	// src/amba/AXI4Delayer.scala:57:17, :92:23, :93:17
      _GEN_5 = wDelayCounter == 32'h0;	// src/amba/AXI4Delayer.scala:33:30, :109:27
      _GEN_6 =
        {{rWaitCounter},
         {_GEN_2 ? 32'h0 : rWaitCounter + 32'h1},
         {rWaitCounter + 32'h1},
         {rWaitCounter}};	// src/amba/AXI4Delayer.scala:30:29, :57:17, :64:{20,36}, :77:{20,36}, :84:{35,60,80}, :87:22
      rWaitCounter <= _GEN_6[rState];	// src/amba/AXI4Delayer.scala:30:29, :56:23, :57:17, :64:20, :84:80
      _GEN_7 =
        {{rDelayCounter},
         {_GEN_2
            ? 32'h0
            : (|rDelayCounter)
                ? rDelayCounter - 32'h1
                : _rDelayCounterQ_deq_q_io_deq_valid
                    ? _rDelayCounterQ_deq_q_io_deq_bits - rWaitCounter
                    : 32'h0},
         {(|rDelayCounter)
            ? rDelayCounter - 32'h1
            : _rDelayCounterQ_deq_q_io_deq_valid
                ? _rDelayCounterQ_deq_q_io_deq_bits - rWaitCounter
                : 32'h0},
         {rDelayCounter}};	// src/amba/AXI4Delayer.scala:30:29, :31:30, :57:17, :66:{21,27,42}, :67:{12,62}, :68:23, :79:{21,27}, :80:{12,62}, :81:23, :84:{35,60,80}, :86:23, src/main/scala/chisel3/util/Decoupled.scala:362:21
      rDelayCounter <= _GEN_7[rState];	// src/amba/AXI4Delayer.scala:31:30, :56:23, :57:17, :66:21, :84:80
      if (~_GEN_3) begin	// src/amba/AXI4Delayer.scala:93:17
        if (_GEN_4)	// src/amba/AXI4Delayer.scala:93:17
          wWaitCounter <= wWaitCounter + 32'h1;	// src/amba/AXI4Delayer.scala:32:29, :100:36
        else if (wState == 2'h2 & _GEN_5)	// src/amba/AXI4Delayer.scala:32:29, :92:23, :93:17, :109:{27,35}, :111:22
          wWaitCounter <= 32'h0;	// src/amba/AXI4Delayer.scala:32:29
      end
      _wDelayCounter_T = {1'h0, wWaitCounter} * 33'h9;	// src/amba/AXI4Delayer.scala:32:29, :103:40
      _GEN_8 =
        {{wDelayCounter},
         {_GEN_5 ? 32'h0 : wDelayCounter - 32'h1},
         {io_out_bvalid ? _wDelayCounter_T[32:1] - wWaitCounter : wDelayCounter},
         {wDelayCounter}};	// src/amba/AXI4Delayer.scala:32:29, :33:30, :93:17, :101:28, :103:{23,40,54,74}, :108:{21,38}, :109:{27,35}, :112:23
      wDelayCounter <= _GEN_8[wState];	// src/amba/AXI4Delayer.scala:33:30, :92:23, :93:17, :101:28, :109:35
      if (_GEN_3 | ~(_GEN_4 & io_out_bvalid)) begin	// src/amba/AXI4Delayer.scala:35:22, :93:17, :101:28, :104:15
      end
      else begin	// src/amba/AXI4Delayer.scala:35:22, :93:17
        bResp_id <= io_out_bid;	// src/amba/AXI4Delayer.scala:35:22
        bResp_resp <= io_out_bresp;	// src/amba/AXI4Delayer.scala:35:22
      end
      rChannelBusy <=
        io_in_arready_0 & io_in_arvalid
        | ~(io_in_rready & io_in_rvalid_0 & _rRespQ_deq_q_io_deq_bits_last)
        & rChannelBusy;	// src/amba/AXI4Delayer.scala:43:29, :45:23, :46:18, :47:{27,48}, :48:18, :125:41, :128:{46,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21
      wChannelBusy <=
        io_in_awready_0 & io_in_awvalid & io_in_wready_0 & io_in_wvalid
        | ~(io_in_bready & (&wState)) & wChannelBusy;	// src/amba/AXI4Delayer.scala:44:29, :50:{23,39}, :51:18, :52:27, :53:18, :92:23, :135:41, :137:39, :140:31, src/main/scala/chisel3/util/Decoupled.scala:51:35
      if (_GEN) begin	// src/amba/AXI4Delayer.scala:57:17
        if (io_in_arvalid)	// src/amba/AXI4Delayer.scala:29:14
          rState <= 2'h1;	// src/amba/AXI4Delayer.scala:56:23, :57:17
      end
      else if (_GEN_0) begin	// src/amba/AXI4Delayer.scala:57:17
        if (io_out_rvalid)	// src/amba/AXI4Delayer.scala:29:14
          rState <= io_out_rlast ? 2'h2 : 2'h1;	// src/amba/AXI4Delayer.scala:56:23, :57:17, :73:22
      end
      else if (_GEN_1 & _GEN_2)	// src/amba/AXI4Delayer.scala:56:23, :57:17, :84:{35,60,80}, :85:16
        rState <= 2'h0;	// src/amba/AXI4Delayer.scala:56:23
      _GEN_9 =
        {{2'h0},
         {_GEN_5 ? 2'h3 : wState},
         {io_out_bvalid ? 2'h2 : wState},
         {io_in_awvalid | io_in_wvalid ? 2'h1 : wState}};	// src/amba/AXI4Delayer.scala:56:23, :57:17, :92:23, :93:17, :95:{28,45}, :96:16, :101:28, :102:16, :109:{27,35}, :110:16, :116:14
      wState <= _GEN_9[wState];	// src/amba/AXI4Delayer.scala:92:23, :93:17, :95:45, :101:28, :109:35, :116:14
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/amba/AXI4Delayer.scala:25:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/amba/AXI4Delayer.scala:25:7
      `FIRRTL_BEFORE_INITIAL	// src/amba/AXI4Delayer.scala:25:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/amba/AXI4Delayer.scala:25:7
      automatic logic [31:0] _RANDOM[0:4];	// src/amba/AXI4Delayer.scala:25:7
      `ifdef INIT_RANDOM_PROLOG_	// src/amba/AXI4Delayer.scala:25:7
        `INIT_RANDOM_PROLOG_	// src/amba/AXI4Delayer.scala:25:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/amba/AXI4Delayer.scala:25:7
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// src/amba/AXI4Delayer.scala:25:7
        end	// src/amba/AXI4Delayer.scala:25:7
        rWaitCounter = _RANDOM[3'h0];	// src/amba/AXI4Delayer.scala:25:7, :30:29
        rDelayCounter = _RANDOM[3'h1];	// src/amba/AXI4Delayer.scala:25:7, :31:30
        wWaitCounter = _RANDOM[3'h2];	// src/amba/AXI4Delayer.scala:25:7, :32:29
        wDelayCounter = _RANDOM[3'h3];	// src/amba/AXI4Delayer.scala:25:7, :33:30
        bResp_id = _RANDOM[3'h4][3:0];	// src/amba/AXI4Delayer.scala:25:7, :35:22
        bResp_resp = _RANDOM[3'h4][5:4];	// src/amba/AXI4Delayer.scala:25:7, :35:22
        rChannelBusy = _RANDOM[3'h4][6];	// src/amba/AXI4Delayer.scala:25:7, :35:22, :43:29
        wChannelBusy = _RANDOM[3'h4][7];	// src/amba/AXI4Delayer.scala:25:7, :35:22, :44:29
        rState = _RANDOM[3'h4][9:8];	// src/amba/AXI4Delayer.scala:25:7, :35:22, :56:23
        wState = _RANDOM[3'h4][11:10];	// src/amba/AXI4Delayer.scala:25:7, :35:22, :92:23
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// src/amba/AXI4Delayer.scala:25:7
      `FIRRTL_AFTER_INITIAL	// src/amba/AXI4Delayer.scala:25:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  Queue8_AXI4BundleR rRespQ_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:362:21
    .clock            (clock),
    .reset            (reset),
    .io_enq_valid     (io_out_rvalid),
    .io_enq_bits_id   (io_out_rid),
    .io_enq_bits_data (io_out_rdata),
    .io_enq_bits_resp (io_out_rresp),
    .io_enq_bits_last (io_out_rlast),
    .io_deq_ready     (io_in_rready & io_in_rvalid_0),	// src/amba/AXI4Delayer.scala:128:{46,62}, src/main/scala/chisel3/util/Decoupled.scala:51:35
    .io_deq_valid     (_rRespQ_deq_q_io_deq_valid),
    .io_deq_bits_id   (io_in_rid),
    .io_deq_bits_data (io_in_rdata),
    .io_deq_bits_resp (io_in_rresp),
    .io_deq_bits_last (_rRespQ_deq_q_io_deq_bits_last)
  );	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  Queue8_UInt32 rDelayCounterQ_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:362:21
    .clock        (clock),
    .reset        (reset),
    .io_enq_valid (io_out_rvalid),
    .io_enq_bits  (_GEN | ~(_GEN_0 & io_out_rvalid) ? 32'h0 : _rCounterW_bits_T[32:1]),	// src/amba/AXI4Delayer.scala:41:18, :57:17, :71:28, :72:{24,41}
    .io_deq_ready (~_GEN & (_GEN_0 ? ~(|rDelayCounter) : _GEN_1 & ~(|rDelayCounter))),	// src/amba/AXI4Delayer.scala:31:30, :39:24, :57:17, :66:42, :70:28, :79:42, :83:28
    .io_deq_valid (_rDelayCounterQ_deq_q_io_deq_valid),
    .io_deq_bits  (_rDelayCounterQ_deq_q_io_deq_bits)
  );	// src/main/scala/chisel3/util/Decoupled.scala:362:21
  assign io_in_awready = io_in_awready_0;	// src/amba/AXI4Delayer.scala:25:7, :135:41
  assign io_in_wready = io_in_wready_0;	// src/amba/AXI4Delayer.scala:25:7, :137:39
  assign io_in_bvalid = &wState;	// src/amba/AXI4Delayer.scala:25:7, :92:23, :140:31
  assign io_in_bid = bResp_id;	// src/amba/AXI4Delayer.scala:25:7, :35:22
  assign io_in_bresp = bResp_resp;	// src/amba/AXI4Delayer.scala:25:7, :35:22
  assign io_in_arready = io_in_arready_0;	// src/amba/AXI4Delayer.scala:25:7, :125:41
  assign io_in_rvalid = io_in_rvalid_0;	// src/amba/AXI4Delayer.scala:25:7, :128:{46,62}
  assign io_in_rlast = _rRespQ_deq_q_io_deq_bits_last;	// src/amba/AXI4Delayer.scala:25:7, src/main/scala/chisel3/util/Decoupled.scala:362:21
  assign io_out_awvalid = io_in_awvalid & ~wChannelBusy;	// src/amba/AXI4Delayer.scala:25:7, :44:29, :135:44, :136:41
  assign io_out_awid = io_in_awid;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awaddr = io_in_awaddr;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awlen = io_in_awlen;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awsize = io_in_awsize;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awburst = io_in_awburst;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awlock = io_in_awlock;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awcache = io_in_awcache;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awprot = io_in_awprot;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_awqos = io_in_awqos;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_wvalid = io_in_wvalid & ~wChannelBusy;	// src/amba/AXI4Delayer.scala:25:7, :44:29, :135:44, :138:39
  assign io_out_wdata = io_in_wdata;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_wstrb = io_in_wstrb;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_wlast = io_in_wlast;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_bready = io_out_bvalid & wState == 2'h1;	// src/amba/AXI4Delayer.scala:25:7, :57:17, :92:23, :139:{40,50}
  assign io_out_arvalid = io_in_arvalid & ~rChannelBusy;	// src/amba/AXI4Delayer.scala:25:7, :43:29, :125:44, :126:41
  assign io_out_arid = io_in_arid;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_araddr = io_in_araddr;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arlen = io_in_arlen;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arsize = io_in_arsize;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arburst = io_in_arburst;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arlock = io_in_arlock;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arcache = io_in_arcache;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arprot = io_in_arprot;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_arqos = io_in_arqos;	// src/amba/AXI4Delayer.scala:25:7
  assign io_out_rready = io_out_rvalid;	// src/amba/AXI4Delayer.scala:25:7
endmodule
...
module ysyxSoCASIC(	// src/SoC.scala:59:9
  ...
  wire        _axi4delay_delayer_io_in_awready;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_in_wready;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_in_bvalid;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_in_bid;	// src/amba/AXI4Delayer.scala:152:27
  wire [1:0]  _axi4delay_delayer_io_in_bresp;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_in_arready;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_in_rvalid;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_in_rid;	// src/amba/AXI4Delayer.scala:152:27
  wire [31:0] _axi4delay_delayer_io_in_rdata;	// src/amba/AXI4Delayer.scala:152:27
  wire [1:0]  _axi4delay_delayer_io_in_rresp;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_in_rlast;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_awvalid;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_awid;	// src/amba/AXI4Delayer.scala:152:27
  wire [31:0] _axi4delay_delayer_io_out_awaddr;	// src/amba/AXI4Delayer.scala:152:27
  wire [7:0]  _axi4delay_delayer_io_out_awlen;	// src/amba/AXI4Delayer.scala:152:27
  wire [2:0]  _axi4delay_delayer_io_out_awsize;	// src/amba/AXI4Delayer.scala:152:27
  wire [1:0]  _axi4delay_delayer_io_out_awburst;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_awlock;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_awcache;	// src/amba/AXI4Delayer.scala:152:27
  wire [2:0]  _axi4delay_delayer_io_out_awprot;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_awqos;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_wvalid;	// src/amba/AXI4Delayer.scala:152:27
  wire [31:0] _axi4delay_delayer_io_out_wdata;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_wstrb;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_wlast;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_bready;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_arvalid;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_arid;	// src/amba/AXI4Delayer.scala:152:27
  wire [31:0] _axi4delay_delayer_io_out_araddr;	// src/amba/AXI4Delayer.scala:152:27
  wire [7:0]  _axi4delay_delayer_io_out_arlen;	// src/amba/AXI4Delayer.scala:152:27
  wire [2:0]  _axi4delay_delayer_io_out_arsize;	// src/amba/AXI4Delayer.scala:152:27
  wire [1:0]  _axi4delay_delayer_io_out_arburst;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_arlock;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_arcache;	// src/amba/AXI4Delayer.scala:152:27
  wire [2:0]  _axi4delay_delayer_io_out_arprot;	// src/amba/AXI4Delayer.scala:152:27
  wire [3:0]  _axi4delay_delayer_io_out_arqos;	// src/amba/AXI4Delayer.scala:152:27
  wire        _axi4delay_delayer_io_out_rready;	// src/amba/AXI4Delayer.scala:152:27
  ...
  wire        _apbdelay_delayer_io_in_pready;	// src/amba/APBDelayer.scala:89:27
  wire        _apbdelay_delayer_io_in_pslverr;	// src/amba/APBDelayer.scala:89:27
  wire [31:0] _apbdelay_delayer_io_in_prdata;	// src/amba/APBDelayer.scala:89:27
  wire        _apbdelay_delayer_io_out_psel;	// src/amba/APBDelayer.scala:89:27
  wire        _apbdelay_delayer_io_out_penable;	// src/amba/APBDelayer.scala:89:27
  wire        _apbdelay_delayer_io_out_pwrite;	// src/amba/APBDelayer.scala:89:27
  wire [31:0] _apbdelay_delayer_io_out_paddr;	// src/amba/APBDelayer.scala:89:27
  wire [31:0] _apbdelay_delayer_io_out_pwdata;	// src/amba/APBDelayer.scala:89:27
  wire [3:0]  _apbdelay_delayer_io_out_pstrb;	// src/amba/APBDelayer.scala:89:27
  ...
  AXI4Xbar axi4xbar (	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    ...
    .auto_anon_out_1_awready      (_axi4delay_delayer_io_in_awready),	// src/amba/AXI4Delayer.scala:152:27
    ...
    .auto_anon_out_1_wready       (_axi4delay_delayer_io_in_wready),	// src/amba/AXI4Delayer.scala:152:27
    ...
    .auto_anon_out_1_bvalid       (_axi4delay_delayer_io_in_bvalid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_bid     (_axi4delay_delayer_io_in_bid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_bresp   (_axi4delay_delayer_io_in_bresp),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_arready      (_axi4delay_delayer_io_in_arready),	// src/amba/AXI4Delayer.scala:152:27
    ...
    .auto_anon_out_1_rvalid       (_axi4delay_delayer_io_in_rvalid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_rid     (_axi4delay_delayer_io_in_rid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_rdata   (_axi4delay_delayer_io_in_rdata),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_rresp   (_axi4delay_delayer_io_in_rresp),	// src/amba/AXI4Delayer.scala:152:27
    .auto_anon_out_1_rlast   (_axi4delay_delayer_io_in_rlast),	// src/amba/AXI4Delayer.scala:152:27
  ...
  APBFanout apbxbar (	// src/SoC.scala:29:27
    .auto_anon_in_psel       (_apbdelay_delayer_io_out_psel),	// src/amba/APBDelayer.scala:89:27
    .auto_anon_in_penable    (_apbdelay_delayer_io_out_penable),	// src/amba/APBDelayer.scala:89:27
    .auto_anon_in_pwrite     (_apbdelay_delayer_io_out_pwrite),	// src/amba/APBDelayer.scala:89:27
    .auto_anon_in_paddr      (_apbdelay_delayer_io_out_paddr),	// src/amba/APBDelayer.scala:89:27
    .auto_anon_in_pwdata     (_apbdelay_delayer_io_out_pwdata),	// src/amba/APBDelayer.scala:89:27
    .auto_anon_in_pstrb      (_apbdelay_delayer_io_out_pstrb),	// src/amba/APBDelayer.scala:89:27
  ...
  AXI4SDRAM lsdram_axi (	// src/SoC.scala:48:60
    ...
    .auto_in_awvalid      (_axi4delay_delayer_io_out_awvalid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awid    (_axi4delay_delayer_io_out_awid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awaddr  (_axi4delay_delayer_io_out_awaddr),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awlen   (_axi4delay_delayer_io_out_awlen),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awsize  (_axi4delay_delayer_io_out_awsize),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awburst (_axi4delay_delayer_io_out_awburst),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awlock  (_axi4delay_delayer_io_out_awlock),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awcache (_axi4delay_delayer_io_out_awcache),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awprot  (_axi4delay_delayer_io_out_awprot),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_awqos   (_axi4delay_delayer_io_out_awqos),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_wready       (_lsdram_axi_auto_in_wready),
    .auto_in_wvalid       (_axi4delay_delayer_io_out_wvalid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_wdata   (_axi4delay_delayer_io_out_wdata),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_wstrb   (_axi4delay_delayer_io_out_wstrb),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_wlast   (_axi4delay_delayer_io_out_wlast),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_bready       (_axi4delay_delayer_io_out_bready),	// src/amba/AXI4Delayer.scala:152:27
    ...
    .auto_in_arvalid      (_axi4delay_delayer_io_out_arvalid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arid    (_axi4delay_delayer_io_out_arid),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_araddr  (_axi4delay_delayer_io_out_araddr),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arlen   (_axi4delay_delayer_io_out_arlen),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arsize  (_axi4delay_delayer_io_out_arsize),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arburst (_axi4delay_delayer_io_out_arburst),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arlock  (_axi4delay_delayer_io_out_arlock),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arcache (_axi4delay_delayer_io_out_arcache),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arprot  (_axi4delay_delayer_io_out_arprot),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_arqos   (_axi4delay_delayer_io_out_arqos),	// src/amba/AXI4Delayer.scala:152:27
    .auto_in_rready       (_axi4delay_delayer_io_out_rready),	// src/amba/AXI4Delayer.scala:152:27
  ...
  APBDelayerChisel apbdelay_delayer (	// src/amba/APBDelayer.scala:89:27
    .clock          (clock),
    .reset          (reset),
  ...
  );	// src/amba/APBDelayer.scala:89:27
  AXI4ToAPB axi42apb (	// src/amba/AXI4ToAPB.scala:103:30
    ...
    .auto_out_pready      (_apbdelay_delayer_io_in_pready),	// src/amba/APBDelayer.scala:89:27
    .auto_out_pslverr     (_apbdelay_delayer_io_in_pslverr),	// src/amba/APBDelayer.scala:89:27
    .auto_out_prdata      (_apbdelay_delayer_io_in_prdata)	// src/amba/APBDelayer.scala:89:27
  ...
  AXI4DelayerChisel axi4delay_delayer (	// src/amba/AXI4Delayer.scala:152:27
    .clock                (clock),
    .reset                (reset),
    .io_in_awready       (_axi4delay_delayer_io_in_awready),
    .io_in_awvalid       (_axi4xbar_auto_anon_out_1_awvalid),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awid     (_axi4xbar_auto_anon_out_1_awid),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awaddr   (_axi4xbar_auto_anon_out_1_awaddr),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awlen    (_axi4xbar_auto_anon_out_1_awlen),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awsize   (_axi4xbar_auto_anon_out_1_awsize),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awburst  (_axi4xbar_auto_anon_out_1_awburst),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awlock   (_axi4xbar_auto_anon_out_1_awlock),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awcache  (_axi4xbar_auto_anon_out_1_awcache),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awprot   (_axi4xbar_auto_anon_out_1_awprot),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_awqos    (_axi4xbar_auto_anon_out_1_awqos),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_wready        (_axi4delay_delayer_io_in_wready),
    .io_in_wvalid        (_axi4xbar_auto_anon_out_1_wvalid),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_wdata    (_axi4xbar_auto_anon_out_1_wdata),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_wstrb    (_axi4xbar_auto_anon_out_1_wstrb),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_wlast    (_axi4xbar_auto_anon_out_1_wlast),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_bready        (_axi4xbar_auto_anon_out_1_bready),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    ...
    .io_in_arvalid       (_axi4xbar_auto_anon_out_1_arvalid),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arid     (_axi4xbar_auto_anon_out_1_arid),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_araddr   (_axi4xbar_auto_anon_out_1_araddr),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arlen    (_axi4xbar_auto_anon_out_1_arlen),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arsize   (_axi4xbar_auto_anon_out_1_arsize),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arburst  (_axi4xbar_auto_anon_out_1_arburst),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arlock   (_axi4xbar_auto_anon_out_1_arlock),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arcache  (_axi4xbar_auto_anon_out_1_arcache),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arprot   (_axi4xbar_auto_anon_out_1_arprot),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_arqos    (_axi4xbar_auto_anon_out_1_arqos),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    .io_in_rready        (_axi4xbar_auto_anon_out_1_rready),	// rocket-chip/src/main/scala/amba/axi4/Xbar.scala:241:30
    ...
    .io_out_awready      (_lsdram_axi_auto_in_awready),	// src/SoC.scala:48:60
    ...
    .io_out_awlock  (_axi4delay_delayer_io_out_awlock),
    .io_out_awcache (_axi4delay_delayer_io_out_awcache),
    .io_out_awprot  (_axi4delay_delayer_io_out_awprot),
    .io_out_awqos   (_axi4delay_delayer_io_out_awqos),
    .io_out_wready       (_lsdram_axi_auto_in_wready),	// src/SoC.scala:48:60
    ...
    .io_out_bvalid       (_lsdram_axi_auto_in_bvalid),	// src/SoC.scala:48:60
    .io_out_bid     (_lsdram_axi_auto_in_bid),	// src/SoC.scala:48:60
    .io_out_bresp   (_lsdram_axi_auto_in_bresp),	// src/SoC.scala:48:60
    .io_out_arready      (_lsdram_axi_auto_in_arready),	// src/SoC.scala:48:60
    ...
    .io_out_arlock  (_axi4delay_delayer_io_out_arlock),
    .io_out_arcache (_axi4delay_delayer_io_out_arcache),
    .io_out_arprot  (_axi4delay_delayer_io_out_arprot),
    .io_out_arqos   (_axi4delay_delayer_io_out_arqos),
    .io_out_rready       (_axi4delay_delayer_io_out_rready),
    .io_out_rvalid       (_lsdram_axi_auto_in_rvalid),	// src/SoC.scala:48:60
    .io_out_rid     (_lsdram_axi_auto_in_rid),	// src/SoC.scala:48:60
    .io_out_rdata   (_lsdram_axi_auto_in_rdata),	// src/SoC.scala:48:60
    .io_out_rresp   (_lsdram_axi_auto_in_rresp),	// src/SoC.scala:48:60
    .io_out_rlast   (_lsdram_axi_auto_in_rlast)	// src/SoC.scala:48:60
  );	// src/amba/AXI4Delayer.scala:152:27
...
// external module PSRAM_READ_HELPER

// external module PSRAM_WRITE_HELPER

module psramChisel(	// src/device/PSRAM.scala:86:7
  input       io_sck,	// src/device/PSRAM.scala:89:14
              io_ce_n,	// src/device/PSRAM.scala:89:14
  inout [3:0] io_dio	// src/device/PSRAM.scala:89:14
);

  wire [31:0] _psram_reader_rdata;	// src/device/PSRAM.scala:103:30
  wire [3:0]  _di_buf_din;	// src/util/TriState.scala:32:21
  reg         mode;	// src/device/PSRAM.scala:92:23
  reg  [2:0]  state;	// src/device/PSRAM.scala:93:24
  reg  [7:0]  counter;	// src/device/PSRAM.scala:94:26
  reg  [7:0]  cmd;	// src/device/PSRAM.scala:95:22
  reg  [23:0] addr;	// src/device/PSRAM.scala:96:23
  reg  [31:0] wdata;	// src/device/PSRAM.scala:97:24
  wire        _di_T = state == 3'h4;	// src/device/PSRAM.scala:86:7, :93:24, :100:48
  wire [31:0] _GEN = {8'h0, addr};	// src/device/PSRAM.scala:96:23, :104:27
  wire        _rdata_T = counter == 8'h0;	// src/device/PSRAM.scala:94:26, :105:56
  wire        _psram_reader_io_ren_T_2 = state == 3'h3 & _rdata_T;	// src/device/PSRAM.scala:93:24, :105:{36,45,56}
  reg  [31:0] rdata;	// src/device/PSRAM.scala:106:26
  reg         do_write;	// src/device/PSRAM.scala:115:27
  reg  [7:0]  wlen;	// src/device/PSRAM.scala:116:23
  wire        _psram_writer_io_wen_T_2 = state == 3'h2;	// src/device/PSRAM.scala:93:24, :119:77
  wire        _GEN_0 = state == 3'h1;	// src/device/PSRAM.scala:86:7, :93:24, :139:18
  wire        _GEN_1 = state == 3'h2;	// src/device/PSRAM.scala:93:24, :119:77, :139:18
  wire        _GEN_2 = state == 3'h3;	// src/device/PSRAM.scala:93:24, :105:36, :139:18
  wire        _GEN_3 = state == 3'h4;	// src/device/PSRAM.scala:86:7, :93:24, :139:18
  `ifndef SYNTHESIS	// src/device/PSRAM.scala:164:15
    always @(posedge io_sck) begin	// src/device/PSRAM.scala:164:15
      automatic logic _GEN_4;	// src/device/PSRAM.scala:139:18
      _GEN_4 = state == 3'h5;	// src/device/PSRAM.scala:93:24, :139:18
      if ((`PRINTF_COND_) & (|state) & ~_GEN_0 & ~_GEN_1 & ~_GEN_2 & ~_GEN_3 & _GEN_4
          & ~io_ce_n)	// src/device/PSRAM.scala:93:24, :119:35, :139:18, :164:15
        $fwrite(32'h80000002, "Error: state = %x, cmd = %x, addr = %x, data = %x\n",
                _GEN_4, cmd, addr, wdata);	// src/device/PSRAM.scala:95:22, :96:23, :97:24, :139:18, :164:15
    end // always @(posedge)
  `endif // not def SYNTHESIS
  always @(posedge io_sck or posedge io_ce_n) begin	// src/device/PSRAM.scala:91:28
    if (io_ce_n) begin	// src/device/PSRAM.scala:91:28
      mode <= 1'h1;	// src/device/PSRAM.scala:92:23
      state <= 3'h0;	// src/device/PSRAM.scala:86:7, :93:24
      counter <= 8'h0;	// src/device/PSRAM.scala:94:26
      cmd <= 8'h0;	// src/device/PSRAM.scala:95:22
      addr <= 24'h0;	// src/device/PSRAM.scala:96:23
      wdata <= 32'h0;	// src/device/PSRAM.scala:97:24
      do_write <= 1'h0;	// src/device/PSRAM.scala:115:27
      wlen <= 8'h0;	// src/device/PSRAM.scala:116:23
    end
    else begin	// src/device/PSRAM.scala:91:28
      automatic logic _state_T_3;	// src/device/PSRAM.scala:132:31
      _state_T_3 = cmd == 8'h35;	// src/device/PSRAM.scala:95:22, :132:31
      mode <= ~(|state) & _state_T_3 ^ mode;	// src/device/PSRAM.scala:92:23, :93:24, :119:35, :132:{24,31,42}, :133:19
      if (|state) begin	// src/device/PSRAM.scala:93:24, :119:35
        automatic logic            _state_T_12;	// src/device/PSRAM.scala:152:30
        automatic logic [7:0][7:0] _GEN_5;	// src/device/PSRAM.scala:94:26, :139:18, :168:18, :173:17, :176:17, :179:17, :182:17, :185:17
        _state_T_12 = counter == 8'h7;	// src/device/PSRAM.scala:94:26, :152:30
        if (_GEN_0)	// src/device/PSRAM.scala:139:18
          state <=
            counter == 8'h5 ? (cmd == 8'hEB ? 3'h3 : cmd == 8'h38 ? 3'h2 : 3'h5) : 3'h1;	// src/device/PSRAM.scala:86:7, :93:24, :94:26, :95:22, :105:36, :119:77, :146:{21,30}, :147:{26,31,52,57}
        else if (_GEN_1)	// src/device/PSRAM.scala:139:18
          state <= {1'h0, ~_state_T_12, 1'h0};	// src/device/PSRAM.scala:93:24, :152:{15,21,30}
        else if (_GEN_2)	// src/device/PSRAM.scala:139:18
          state <= counter == 8'h6 ? 3'h4 : 3'h3;	// src/device/PSRAM.scala:86:7, :93:24, :94:26, :105:36, :158:{21,30}
        else if (_GEN_3)	// src/device/PSRAM.scala:139:18
          state <= {counter != 8'h7, 2'h0};	// src/device/PSRAM.scala:86:7, :93:24, :94:26, :161:{21,30}
        _GEN_5 =
          {{counter},
           {counter},
           {8'h0},
           {counter == 8'h7 ? 8'h0 : counter + 8'h1},
           {counter == 8'h6 ? 8'h0 : counter + 8'h1},
           {counter == 8'h7 ? 8'h0 : counter + 8'h1},
           {counter == 8'h5 ? 8'h0 : counter + 8'h1},
           {counter}};	// src/device/PSRAM.scala:94:26, :139:18, :168:18, :173:{17,23,32,54}, :176:{17,23,32,54}, :179:{17,23,32,54}, :182:{17,23,32,54}, :185:17
        counter <= _GEN_5[state];	// src/device/PSRAM.scala:93:24, :94:26, :139:18, :168:18, :173:17, :176:17, :179:17, :182:17, :185:17
        if (_GEN_0
            | ~(_GEN_1
                & (counter == 8'h1 | counter == 8'h3 | counter == 8'h5
                   | _state_T_12))) begin	// src/device/PSRAM.scala:94:26, :116:23, :139:18, :152:30, :153:{22,30,41,49,60,68,87}, :154:16
        end
        else	// src/device/PSRAM.scala:116:23, :139:18
          wlen <= wlen + 8'h1;	// src/device/PSRAM.scala:116:23, :154:24
      end
      else begin	// src/device/PSRAM.scala:119:35
        state <= {2'h0, counter == {5'h0, mode ? 3'h1 : 3'h7} & ~_state_T_3};	// src/device/PSRAM.scala:86:7, :92:23, :93:24, :94:26, :125:13, :132:31, :141:{15,21,30,37,67}
        if (counter == {5'h0, mode ? 3'h1 : 3'h7})	// src/device/PSRAM.scala:86:7, :92:23, :94:26, :125:13, :170:{32,39}
          counter <= 8'h0;	// src/device/PSRAM.scala:94:26
        else	// src/device/PSRAM.scala:170:32
          counter <= counter + 8'h1;	// src/device/PSRAM.scala:94:26, :170:79
        if (mode)	// src/device/PSRAM.scala:92:23
          cmd <= {cmd[3:0], _di_buf_din};	// src/device/PSRAM.scala:95:22, :191:{59,63}, src/util/TriState.scala:32:21
        else	// src/device/PSRAM.scala:92:23
          cmd <= {cmd[6:0], _di_buf_din[0]};	// src/device/PSRAM.scala:95:22, :191:{36,40,50}, src/util/TriState.scala:32:21
        wlen <= 8'h0;	// src/device/PSRAM.scala:116:23
      end
      if (_GEN_0)	// src/device/PSRAM.scala:139:18
        addr <= {addr[19:0], _di_buf_din};	// src/device/PSRAM.scala:96:23, :194:{18,23}, src/util/TriState.scala:32:21
      if (_psram_writer_io_wen_T_2)	// src/device/PSRAM.scala:119:77
        wdata <= {wdata[27:0], _di_buf_din};	// src/device/PSRAM.scala:97:24, :197:{19,25}, src/util/TriState.scala:32:21
      do_write <= (|state) & (~_GEN_0 & _GEN_1 | do_write);	// src/device/PSRAM.scala:93:24, :115:27, :119:35, :139:18, :143:18
    end
  end // always @(posedge, posedge)
  always @(posedge io_sck) begin	// src/device/PSRAM.scala:91:28
    if (_di_T)	// src/device/PSRAM.scala:100:48
      rdata <=
        {4'h0,
         _rdata_T
           ? {rdata[27:24],
              ...
              rdata[15:12],
              rdata[3:0]}
           : rdata[31:4]};	// src/device/PSRAM.scala:105:56, :106:26, :108:{22,37}, :109:{22,37}, :110:{22,37}, :111:22, :201:{13,19,40,56,69,80}
    else if (_psram_reader_io_ren_T_2)	// src/device/PSRAM.scala:105:45
      rdata <= _psram_reader_rdata;	// src/device/PSRAM.scala:103:30, :106:26
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/device/PSRAM.scala:86:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/device/PSRAM.scala:86:7
      `FIRRTL_BEFORE_INITIAL	// src/device/PSRAM.scala:86:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/device/PSRAM.scala:86:7
      automatic logic [31:0] _RANDOM[0:3];	// src/device/PSRAM.scala:86:7
      `ifdef INIT_RANDOM_PROLOG_	// src/device/PSRAM.scala:86:7
        `INIT_RANDOM_PROLOG_	// src/device/PSRAM.scala:86:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/device/PSRAM.scala:86:7
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// src/device/PSRAM.scala:86:7
        end	// src/device/PSRAM.scala:86:7
        mode = _RANDOM[2'h0][0];	// src/device/PSRAM.scala:86:7, :92:23
        state = _RANDOM[2'h0][3:1];	// src/device/PSRAM.scala:86:7, :92:23, :93:24
        counter = _RANDOM[2'h0][11:4];	// src/device/PSRAM.scala:86:7, :92:23, :94:26
        cmd = _RANDOM[2'h0][19:12];	// src/device/PSRAM.scala:86:7, :92:23, :95:22
        addr = {_RANDOM[2'h0][31:20], _RANDOM[2'h1][11:0]};	// src/device/PSRAM.scala:86:7, :92:23, :96:23
        wdata = {_RANDOM[2'h1][31:12], _RANDOM[2'h2][11:0]};	// src/device/PSRAM.scala:86:7, :96:23, :97:24
        rdata = {_RANDOM[2'h2][31:12], _RANDOM[2'h3][11:0]};	// src/device/PSRAM.scala:86:7, :97:24, :106:26
        do_write = _RANDOM[2'h3][12];	// src/device/PSRAM.scala:86:7, :106:26, :115:27
        wlen = _RANDOM[2'h3][20:13];	// src/device/PSRAM.scala:86:7, :106:26, :116:23
      `endif // RANDOMIZE_REG_INIT
      if (io_ce_n) begin	// src/device/PSRAM.scala:86:7
        mode = 1'h1;	// src/device/PSRAM.scala:92:23
        state = 3'h0;	// src/device/PSRAM.scala:86:7, :93:24
        counter = 8'h0;	// src/device/PSRAM.scala:94:26
        cmd = 8'h0;	// src/device/PSRAM.scala:95:22
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// src/device/PSRAM.scala:86:7
      `FIRRTL_AFTER_INITIAL	// src/device/PSRAM.scala:86:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  TriStateInBuf #(
    .width(4)
  ) di_buf (	// src/util/TriState.scala:32:21
    .dio    (io_dio),
    .dout   (_di_T ? (_rdata_T ? rdata[7:4] : rdata[3:0]) : 4'h0),	// src/device/PSRAM.scala:99:27, :100:48, :105:56, :106:26, :111:{22,37}, :199:25, :200:{12,18}
    .out_en (_di_T),	// src/device/PSRAM.scala:100:48
    .din    (_di_buf_din)
  );	// src/util/TriState.scala:32:21
  PSRAM_READ_HELPER psram_reader (	// src/device/PSRAM.scala:103:30
    .raddr (_GEN),	// src/device/PSRAM.scala:104:27
    .ren   (_psram_reader_io_ren_T_2),	// src/device/PSRAM.scala:105:45
    .rdata (_psram_reader_rdata)
  );	// src/device/PSRAM.scala:103:30
  PSRAM_WRITE_HELPER psram_writer (	// src/device/PSRAM.scala:117:30
    .clk   (io_sck),
    .waddr (_GEN),	// src/device/PSRAM.scala:104:27
    .wen   (~(|state) & do_write | io_ce_n & _psram_writer_io_wen_T_2),	// src/device/PSRAM.scala:93:24, :115:27, :119:{35,43,56,68,77}
    .wlen  (wlen),	// src/device/PSRAM.scala:116:23
    .wdata
      (wlen == 8'h1
         ? {24'h0, wdata[7:0]}
         : wlen == 8'h2
             ? {16'h0, wdata[7:0], wdata[15:8]}
             : wlen == 8'h4
                 ? {wdata[7:0], wdata[15:8], wdata[23:16], wdata[31:24]}
                 : 32'h0)	// src/device/PSRAM.scala:97:24, :116:23, :123:{13,28,45}, :124:{13,28,58}, :125:{13,28,61,76}, src/main/scala/chisel3/util/Mux.scala:126:16
  );	// src/device/PSRAM.scala:117:30
endmodule
...
module sdramChisel(	// src/device/SDRAM.scala:131:7
  input        io_clk,	// src/device/SDRAM.scala:134:14
               io_cke,	// src/device/SDRAM.scala:134:14
               io_cs,	// src/device/SDRAM.scala:134:14
               io_ras,	// src/device/SDRAM.scala:134:14
               io_cas,	// src/device/SDRAM.scala:134:14
               io_we,	// src/device/SDRAM.scala:134:14
  input [12:0] io_a,	// src/device/SDRAM.scala:134:14
  input [1:0]  io_ba,	// src/device/SDRAM.scala:134:14
  input [3:0]  io_dqm,	// src/device/SDRAM.scala:134:14
  inout [31:0] io_dq	// src/device/SDRAM.scala:134:14
);

  wire [31:0] _dqin_buf_din;	// src/util/TriState.scala:32:21
  wire [31:0] _readHelper_rdata;	// src/device/SDRAM.scala:165:28
  wire        _GEN = ~io_clk;	// src/device/SDRAM.scala:135:22
  wire        _GEN_0 = ~io_cke;	// src/device/SDRAM.scala:135:41
  reg  [12:0] modeReg;	// src/device/SDRAM.scala:137:26
  wire [3:0]  cmd = {io_cs, io_ras, io_cas, io_we};	// src/device/SDRAM.scala:151:18
  reg  [2:0]  state;	// src/device/SDRAM.scala:152:24
  reg  [2:0]  casCounter;	// src/device/SDRAM.scala:153:29
  reg  [2:0]  burstCounter;	// src/device/SDRAM.scala:154:31
  reg  [12:0] a_r;	// src/device/SDRAM.scala:156:22
  reg  [1:0]  ba_r;	// src/device/SDRAM.scala:157:23
  wire [12:0] _writeHelper_io_a_T_1 = a_r + {10'h0, burstCounter};	// src/device/SDRAM.scala:154:31, :156:22, :174:33
  wire        _GEN_1 = cmd == 4'h0;	// src/device/SDRAM.scala:151:18, :187:21
  wire        _GEN_2 = cmd == 4'h3;	// src/device/SDRAM.scala:151:18, :187:21
  wire        _GEN_3 = cmd == 4'h5;	// src/device/SDRAM.scala:151:18, :187:21
  wire        _GEN_4 = cmd == 4'h4;	// src/device/SDRAM.scala:151:18, :187:21
  wire        _GEN_5 = _GEN_1 | _GEN_2 | _GEN_3;	// src/device/SDRAM.scala:154:31, :187:21
  wire        _GEN_6 = state == 3'h4;	// src/device/SDRAM.scala:152:24, :185:18
  wire        _GEN_7 = state == 3'h2;	// src/device/SDRAM.scala:147:25, :152:24, :185:18
  wire        readHelperEnable = ~(~(|state) | _GEN_6) & _GEN_7;	// src/device/SDRAM.scala:152:24, :166:39, :179:40, :185:18
  wire        _GEN_8 = state == 3'h3;	// src/device/SDRAM.scala:152:24, :185:18
  always @(posedge _GEN or posedge _GEN_0) begin	// src/device/SDRAM.scala:135:{22,31,41}
    if (_GEN_0) begin	// src/device/SDRAM.scala:135:{31,41}
      modeReg <= 13'h0;	// src/device/SDRAM.scala:137:26
      state <= 3'h0;	// src/device/SDRAM.scala:152:24
      casCounter <= 3'h0;	// src/device/SDRAM.scala:153:29
      burstCounter <= 3'h0;	// src/device/SDRAM.scala:154:31
      a_r <= 13'h0;	// src/device/SDRAM.scala:156:22
      ba_r <= 2'h0;	// src/device/SDRAM.scala:131:7, :157:23
    end
    else begin	// src/device/SDRAM.scala:135:31
      automatic logic [3:0] burstLength;	// src/main/scala/chisel3/util/Mux.scala:126:16
      automatic logic       _GEN_9;	// src/device/SDRAM.scala:153:29, :187:21
      automatic logic [3:0] _GEN_10;	// src/device/SDRAM.scala:203:39
      burstLength =
        modeReg[2:0] == 3'h0
          ? 4'h1
          : modeReg[2:0] == 3'h1
              ? 4'h2
              : modeReg[2:0] == 3'h2 ? 4'h4 : {modeReg[2:0] == 3'h3, 3'h0};	// src/device/SDRAM.scala:137:26, :138:35, :145:25, :146:25, :147:25, :148:25, :198:56, src/main/scala/chisel3/util/Mux.scala:126:16
      _GEN_9 = _GEN_1 | _GEN_2;	// src/device/SDRAM.scala:153:29, :187:21
      _GEN_10 = {1'h0, burstCounter};	// src/device/SDRAM.scala:131:7, :154:31, :203:39
      if (~(|state) & _GEN_1)	// src/device/SDRAM.scala:137:26, :152:24, :179:40, :185:18, :187:21, :189:21
        modeReg <= io_a;	// src/device/SDRAM.scala:137:26
      if (|state) begin	// src/device/SDRAM.scala:152:24, :179:40
        if (_GEN_6) begin	// src/device/SDRAM.scala:185:18
          automatic logic [2:0] _state_T_4;	// src/device/SDRAM.scala:210:52
          _state_T_4 = modeReg[6:4] - 3'h1;	// src/device/SDRAM.scala:137:26, :140:28, :210:52
          state <= casCounter == _state_T_4 ? 3'h2 : 3'h4;	// src/device/SDRAM.scala:147:25, :152:24, :153:29, :210:52, :211:{21,33}
          if (casCounter == _state_T_4)	// src/device/SDRAM.scala:153:29, :210:{38,52}
            casCounter <= 3'h0;	// src/device/SDRAM.scala:153:29
          else	// src/device/SDRAM.scala:210:38
            casCounter <= casCounter + 3'h1;	// src/device/SDRAM.scala:153:29, :210:75
        end
        else if (_GEN_7) begin	// src/device/SDRAM.scala:185:18
          automatic logic [3:0] _state_T_8;	// src/device/SDRAM.scala:214:58
          _state_T_8 = burstLength - 4'h1;	// src/device/SDRAM.scala:214:58, src/main/scala/chisel3/util/Mux.scala:126:16
          state <= {1'h0, _GEN_10 != _state_T_8, 1'h0};	// src/device/SDRAM.scala:131:7, :152:24, :203:39, :214:58, :215:{15,35}
          if (_GEN_10 == _state_T_8)	// src/device/SDRAM.scala:203:39, :214:{42,58}
            burstCounter <= 3'h0;	// src/device/SDRAM.scala:154:31
          else	// src/device/SDRAM.scala:214:42
            burstCounter <= burstCounter + 3'h1;	// src/device/SDRAM.scala:154:31, :214:83
        end
        else if (_GEN_8) begin	// src/device/SDRAM.scala:185:18
          automatic logic [3:0] _state_T_12;	// src/device/SDRAM.scala:219:58
          _state_T_12 = burstLength - 4'h1;	// src/device/SDRAM.scala:219:58, src/main/scala/chisel3/util/Mux.scala:126:16
          state <= {1'h0, _GEN_10 == _state_T_12 ? 2'h0 : 2'h3};	// src/device/SDRAM.scala:131:7, :152:24, :203:39, :219:58, :220:{15,21,35}
          if (_GEN_10 == _state_T_12)	// src/device/SDRAM.scala:203:39, :219:{42,58}
            burstCounter <= 3'h0;	// src/device/SDRAM.scala:154:31
          else	// src/device/SDRAM.scala:219:42
            burstCounter <= burstCounter + 3'h1;	// src/device/SDRAM.scala:154:31, :219:83
        end
      end
      else begin	// src/device/SDRAM.scala:179:40
        automatic logic [3:0] _burstCounter_T;	// src/device/SDRAM.scala:203:55
        _burstCounter_T = burstLength - 4'h1;	// src/device/SDRAM.scala:203:55, src/main/scala/chisel3/util/Mux.scala:126:16
        if (~_GEN_9) begin	// src/device/SDRAM.scala:153:29, :187:21
          if (_GEN_3)	// src/device/SDRAM.scala:187:21
            state <= 3'h2;	// src/device/SDRAM.scala:147:25, :152:24
          else if (_GEN_4)	// src/device/SDRAM.scala:187:21
            state <= {1'h0, _GEN_10 == _burstCounter_T ? 2'h0 : 2'h3};	// src/device/SDRAM.scala:131:7, :152:24, :203:{19,25,39,55}
        end
        if (_GEN_9 | ~_GEN_3) begin	// src/device/SDRAM.scala:153:29, :187:21
        end
        else if (casCounter == modeReg[6:4] - 3'h1)	// src/device/SDRAM.scala:137:26, :140:28, :153:29, :198:{42,56}
          casCounter <= 3'h0;	// src/device/SDRAM.scala:153:29
        else	// src/device/SDRAM.scala:198:42
          casCounter <= casCounter + 3'h1;	// src/device/SDRAM.scala:153:29, :198:79
        if (_GEN_5 | ~_GEN_4) begin	// src/device/SDRAM.scala:154:31, :187:21
        end
        else if (_GEN_10 == _burstCounter_T)	// src/device/SDRAM.scala:203:{39,55}, :204:46
          burstCounter <= 3'h0;	// src/device/SDRAM.scala:154:31
        else	// src/device/SDRAM.scala:204:46
          burstCounter <= burstCounter + 3'h1;	// src/device/SDRAM.scala:154:31, :204:87
      end
      if ((|state) | _GEN_9 | ~(_GEN_3 | _GEN_4)) begin	// src/device/SDRAM.scala:152:24, :153:29, :156:22, :157:23, :179:40, :185:18, :187:21, :195:17, :201:17
      end
      else begin	// src/device/SDRAM.scala:157:23, :185:18, :187:21
        a_r <= io_a;	// src/device/SDRAM.scala:156:22
        ba_r <= io_ba;	// src/device/SDRAM.scala:157:23
      end
    end
  end // always @(posedge, posedge)
  `ifdef ENABLE_INITIAL_REG_	// src/device/SDRAM.scala:131:7
    `ifdef FIRRTL_BEFORE_INITIAL	// src/device/SDRAM.scala:131:7
      `FIRRTL_BEFORE_INITIAL	// src/device/SDRAM.scala:131:7
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// src/device/SDRAM.scala:131:7
      automatic logic [31:0] _RANDOM[0:1];	// src/device/SDRAM.scala:131:7
      `ifdef INIT_RANDOM_PROLOG_	// src/device/SDRAM.scala:131:7
        `INIT_RANDOM_PROLOG_	// src/device/SDRAM.scala:131:7
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// src/device/SDRAM.scala:131:7
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          _RANDOM[i[0]] = `RANDOM;	// src/device/SDRAM.scala:131:7
        end	// src/device/SDRAM.scala:131:7
        modeReg = _RANDOM[1'h0][12:0];	// src/device/SDRAM.scala:131:7, :137:26
        state = _RANDOM[1'h0][15:13];	// src/device/SDRAM.scala:131:7, :137:26, :152:24
        casCounter = _RANDOM[1'h0][18:16];	// src/device/SDRAM.scala:131:7, :137:26, :153:29
        burstCounter = _RANDOM[1'h0][21:19];	// src/device/SDRAM.scala:131:7, :137:26, :154:31
        a_r = {_RANDOM[1'h0][31:22], _RANDOM[1'h1][2:0]};	// src/device/SDRAM.scala:131:7, :137:26, :156:22
        ba_r = _RANDOM[1'h1][4:3];	// src/device/SDRAM.scala:131:7, :156:22, :157:23
      `endif // RANDOMIZE_REG_INIT
      if (_GEN_0) begin	// src/device/SDRAM.scala:131:7, :135:41
        modeReg = 13'h0;	// src/device/SDRAM.scala:137:26
        state = 3'h0;	// src/device/SDRAM.scala:152:24
        casCounter = 3'h0;	// src/device/SDRAM.scala:153:29
        burstCounter = 3'h0;	// src/device/SDRAM.scala:154:31
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// src/device/SDRAM.scala:131:7
      `FIRRTL_AFTER_INITIAL	// src/device/SDRAM.scala:131:7
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  SDRAM_ACTIVE_HELPER activeHelper (	// src/device/SDRAM.scala:159:30
    .ba     (io_ba),
    .a      (io_a),
    .enable (~(|state) & ~_GEN_1 & _GEN_2)	// src/device/SDRAM.scala:152:24, :160:41, :179:40, :185:18, :187:21
  );	// src/device/SDRAM.scala:159:30
  SDRAM_READ_HELPER readHelper (	// src/device/SDRAM.scala:165:28
    .ba     (ba_r),	// src/device/SDRAM.scala:157:23
    .a      (_writeHelper_io_a_T_1),	// src/device/SDRAM.scala:174:33
    .enable (readHelperEnable),	// src/device/SDRAM.scala:166:39, :185:18
    .rdata  (_readHelper_rdata)
  );	// src/device/SDRAM.scala:165:28
  SDRAM_WRITE_HELPER writeHelper (	// src/device/SDRAM.scala:167:29
    .ba     (io_ba),
    .a      ((|state) ? _writeHelper_io_a_T_1 : io_a),	// src/device/SDRAM.scala:152:24, :174:33, :179:{33,40}
    .wdata  (_dqin_buf_din),	// src/util/TriState.scala:32:21
    .dqm    (io_dqm),
    .enable ((|state) ? ~(_GEN_6 | _GEN_7) & _GEN_8 : ~_GEN_5 & _GEN_4)	// src/device/SDRAM.scala:152:24, :154:31, :168:40, :179:40, :185:18, :187:21
  );	// src/device/SDRAM.scala:167:29
  TriStateInBuf #(
    .width(32)
  ) dqin_buf (	// src/util/TriState.scala:32:21
    .dio    (io_dq),
    .dout   (_readHelper_rdata),	// src/device/SDRAM.scala:165:28
    .out_en (readHelperEnable),	// src/device/SDRAM.scala:166:39, :185:18
    .din    (_dqin_buf_din)
  );	// src/util/TriState.scala:32:21
endmodule
...
module ysyxSoCFull(	// src/SoC.scala:111:9
  ...
  wire [31:0] _io_dq_wire;	// src/SoC.scala:145:23
  ...
  psramChisel psram (	// src/SoC.scala:143:23
    .io_sck  (_asic_psram_sck),	// src/SoC.scala:107:24
    .io_ce_n (_asic_psram_ce_n),	// src/SoC.scala:107:24
    .io_dio  (_io_dio_wire)
  );	// src/SoC.scala:143:23
  sdramChisel sdram (	// src/SoC.scala:145:23
    .io_clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .io_cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .io_cs  (_asic_sdram_cs),	// src/SoC.scala:107:24
    .io_ras (_asic_sdram_ras),	// src/SoC.scala:107:24
    .io_cas (_asic_sdram_cas),	// src/SoC.scala:107:24
    .io_we  (_asic_sdram_we),	// src/SoC.scala:107:24
    .io_a   (_asic_sdram_a),	// src/SoC.scala:107:24
    .io_ba  (_asic_sdram_ba),	// src/SoC.scala:107:24
    .io_dqm (_asic_sdram_dqm),	// src/SoC.scala:107:24
    .io_dq  (_io_dq_wire)
