...
object ControlLogic{
  ...
  val table = TruthTable(Map(
    ...
    WFI     -> Seq(InstType.R, FuType.ALU, OpASrc.ZERO   , OpBSrc.ZERO, ALUOp.ADD , MULOp.X     , DIVOp.X   , BRUOp.N  , CSROp.N , AMOOp.X   , MemWrite.N, MemRead.N , MemSignExt.SignedExt  , CSRWrite.N, RegWrite.N, Fence.N, Legal.Y),
