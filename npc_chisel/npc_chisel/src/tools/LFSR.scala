...
/** Linear Feedback Shift Register generate a LFSR of `nr_bits` bits with the
  * feedback function of `func`
  *
  * @param nr_bits
  * @param func
  */
...
case class LFSR(nr_bits: Int = 8, func: UInt => Bool = defaultFunc)
    extends Module {
